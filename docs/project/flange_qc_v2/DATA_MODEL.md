...
more frames, zero or one model artifact manifest reference, one measurement set,
zero or more detector observations, many rule results, one decision, and
optional QC feedback entries.
