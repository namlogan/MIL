...
|---|---|---|---|---|---|
| FQV2-Q-001 | What is the target product repository and `repo_id`? | Critical | Product owner | Open | TBD |
| FQV2-Q-002 | Should FLANGE QC V2 live inside MIL, a new repo, or an existing FLANGE repo? | Critical | Product owner | Open | TBD |
