...
class HmiScreenTests(unittest.TestCase):
    def test_hmi_endpoint_returns_operator_screen_html(self) -> None:
        ...
        self.assertIn('id="measurement-source"', body)
        self.assertIn('id="measurement-evidence"', body)
    ...
    def test_hmi_html_binds_to_websocket_snapshot_fields(self) -> None:
        ...
        self.assertIn("renderMeasurementEvidence", html)
        self.assertIn("measurement_source", html)
        self.assertIn("measurement_evidence", html)
    ...
    def test_hmi_html_renders_signal_first_qc_tablet_viewport(self) -> None:
        ...
        self.assertIn('id="product-scope-chip"', html)
        self.assertIn('id="measurement-scope-card"', html)
        self.assertIn('id="measurement-scope-status"', html)
        self.assertIn('id="measurement-scope-detail"', html)
        self.assertIn('id="stitch-scope-card"', html)
        self.assertIn('id="stitch-scope-status"', html)
        self.assertIn('id="stitch-scope-detail"', html)
        self.assertIn("Do luong", html)
        self.assertIn("Mui chi", html)
    ...
    def test_hmi_html_defines_qc_tablet_state_overlay_and_feedback_helpers(self) -> None:
        ...
        self.assertIn("measurementScopeState", html)
        self.assertIn("stitchScopeState", html)
        self.assertIn("formatMeasurementScopeDetail", html)
        self.assertIn("formatObservationScopeDetail", html)
